...
function compute_group_statistics(results, group)
    ...
    statistics = (group, freq, avg_n_episodes, avg_expected_reward_s, avg_expected_reward_r, avg_expected_aggregate_reward, 
                  avg_absolute_error_s, avg_absolute_error_r, avg_mutual_information, min_absolute_error, quant_absolute_error)
    var_names = @names(group, freq, avg_n_episodes, avg_expected_reward_s, avg_expected_reward_r, avg_expected_aggregate_reward, 
                  avg_absolute_error_s, avg_absolute_error_r, avg_mutual_information, min_absolute_error, quant_absolute_error)
